 ...
 * @author emarfkrow
 */
public class T07OrgRegistForm implements IForm {
    ...
    private java.util.List<T07OrgDetRegistForm> t07OrgDetGrid;

    /**
     * @return 起源明細
     */
    public java.util.List<T07OrgDetRegistForm> getT07OrgDetGrid() {
     ...
     * @param p
     */
    public void setT07OrgDetGrid(final java.util.List<T07OrgDetRegistForm> p) {
