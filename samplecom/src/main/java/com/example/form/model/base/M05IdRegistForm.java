 ...
 * @author emarfkrow
 */
public class M05IdRegistForm implements IForm {
    ...
    private java.util.List<M05IdbnRegistForm> m05IdbnGrid;

    /**
     * @return ID連番マスタ
     */
    public java.util.List<M05IdbnRegistForm> getM05IdbnGrid() {
        return m05IdbnGrid;
    }
     ...
     * @param p
     */
    public void setM05IdbnGrid(final java.util.List<M05IdbnRegistForm> p) {
        this.m05IdbnGrid = p;
    }
