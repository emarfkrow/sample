 ...
 * @author emarfkrow
 */
public class T00JissekiRegistForm implements IForm {
    ...
    public void validate(final Map<String, String> errors, final BaseProcess baseProcess) {
        ...
        baseProcess.masterCheck(errors, "T00KouteiSearch", "kouteiId", kouteiIdParams, jp.co.golorp.emarf.util.Messages.get("T00Jisseki.kouteiId"));
    }
}
