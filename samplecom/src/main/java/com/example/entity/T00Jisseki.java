 ...
 * @author emarfkrow
 */
public class T00Jisseki implements IEntity {
    ...
    /** @param values */
    public T00Jisseki(final String[] values) {
    ...
    /** @param map */
    public T00Jisseki(final java.util.Map<String, Object> map) {
     ...
     * @return 実績
     */
    public static T00Jisseki get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T00Jisseki.class);
    }
    ...
    public int insert(final java.time.LocalDateTime now, final String execId) {
        ...
        // 実績の登録
        String sql = "INSERT INTO T00_JISSEKI(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`JISSEKI_BN`) IS NULL THEN 0 ELSE MAX(e.`JISSEKI_BN`) * 1 END + 1 AS `JISSEKI_BN` FROM T00_JISSEKI e";
        java.util.Map<String, Object> map = new java.util.HashMap<String, Object>();
        java.util.List<String> whereList = new java.util.ArrayList<String>();
    ...
    public int delete() {
        ...
        // 実績の削除
        String sql = "DELETE FROM T00_JISSEKI WHERE " + getWhere();
    ...
    public static int truncate() {
        ...
        // 実績の削除
        String sql = "TRUNCATE TABLE T00_JISSEKI";
