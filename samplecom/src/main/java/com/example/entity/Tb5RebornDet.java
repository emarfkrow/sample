 ...
 * @author emarfkrow
 */
public class Tb5RebornDet implements IEntity {
    ...
    /** @return 前世明細情報 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "PREV_DET_INFO", index = 4)
    public String getPrevDetInfo() {
        return this.prevDetInfo;
    }

    /** @param o 前世明細情報 */
    public void setPrevDetInfo(final Object o) {
        if (o != null) {
            this.prevDetInfo = o.toString();
        } else {
            this.prevDetInfo = null;
        }
    }
     ...
     * @return 転生明細
     */
    public static Tb5RebornDet get(final Object param1, final Object param2) {
        ...
        sql += "FROM \n";
        sql += "    TB5_REBORN_DET a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("reborn_id", param1);
        map.put("reborn_bn", param2);
        return Queries.get(sql, map, Tb5RebornDet.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 転生明細の登録
        String sql = "INSERT INTO TB5_REBORN_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`PREV_DET_INFO` -- :prev_det_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REBORN_BN`) IS NULL THEN 0 ELSE MAX(e.`REBORN_BN`) * 1 END + 1 AS `REBORN_BN` FROM TB5_REBORN_DET e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 転生明細の登録
        String sql = "UPDATE TB5_REBORN_DET\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    private String getSet() {
        ...
        setList.add("`PREV_DET_INFO` = :prev_det_info");
    ...
    public int delete() {
        ...
        // 転生明細の削除
        String sql = "DELETE FROM TB5_REBORN_DET WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("prev_det_info", this.prevDetInfo);
