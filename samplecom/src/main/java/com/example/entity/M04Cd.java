...
public class M04Cd implements IEntity {
    ...
    /** @param values */
    public M04Cd(final String[] values) {
    ...
    /** @param map */
    public M04Cd(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.cdrefCd)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static M04Cd get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, M04Cd.class);
    }
