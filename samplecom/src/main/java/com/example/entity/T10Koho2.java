...
public class T10Koho2 implements IEntity {
    ...
    /** @param values */
    public T10Koho2(final String[] values) {
    ...
    /** @param map */
    public T10Koho2(final java.util.Map<String, Object> map) {
    ...
    public static T10Koho2 get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T10Koho2.class);
    }
    ...
    public static int truncate() {
        ...
        // 候補２の削除
        String sql = "TRUNCATE TABLE T10_KOHO2";
