...
public class T10Choice implements IEntity {
    ...
    /** @param values */
    public T10Choice(final String[] values) {
    ...
    /** @param map */
    public T10Choice(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.choiceId)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
