 ...
 * @author emarfkrow
 */
public class Tb9Src implements IEntity {
     ...
     * @return 変換元
     */
    public static Tb9Src get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb9Src.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変換元の登録
        String sql = "INSERT INTO TB9_SRC(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SRC_ID`) IS NULL THEN 0 ELSE MAX(e.`SRC_ID`) * 1 END + 1 AS `SRC_ID` FROM TB9_SRC e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 変換元の削除
        String sql = "DELETE FROM TB9_SRC WHERE " + getWhere();
