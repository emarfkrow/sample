 ...
 * @author emarfkrow
 */
public class Tb6OrgDet implements IEntity {
    ...
    public static Tb6OrgDet get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb6OrgDet.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 起源明細の登録
        String sql = "INSERT INTO TB6_ORG_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`ORG_BN`) IS NULL THEN 0 ELSE MAX(e.`ORG_BN`) * 1 END + 1 AS `ORG_BN` FROM TB6_ORG_DET e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // 起源明細の削除
        String sql = "DELETE FROM TB6_ORG_DET WHERE " + getWhere();
