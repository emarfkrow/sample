 ...
 * @author emarfkrow
 */
public class Tb1Refer2 implements IEntity {
    ...
    /** @return 参照２ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REFER2_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return 参照２名 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REFER2_MEI", index = 3)
     ...
     * @return 参照２マスタ
     */
    public static Tb1Refer2 get(final Object param1) {
        ...
        map.put("refer_2_id", param1);
        return Queries.get(sql, map, Tb1Refer2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照２マスタの登録
        String sql = "INSERT INTO TB1_REFER2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`REFER2_MEI` -- :refer_2_mei");
    ...
    private void numbering() {
        if (this.refer2Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`REFER2_ID`) IS NULL THEN 0 ELSE MAX(e.`REFER2_ID`) * 1 END + 1 AS `REFER2_ID` FROM TB1_REFER2 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("REFER2_ID");
        this.setRefer2Id(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`REFER2_MEI` = :refer_2_mei");
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("refer_2_mei", this.refer2Mei);
