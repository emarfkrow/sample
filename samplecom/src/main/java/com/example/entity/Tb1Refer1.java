 ...
 * @author emarfkrow
 */
public class Tb1Refer1 implements IEntity {
     ...
     * @return 参照１マスタ
     */
    public static Tb1Refer1 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb1Refer1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照１マスタの登録
        String sql = "INSERT INTO TB1_REFER1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`REFER1_MEI` -- :refer_1_mei");
    ...
    private void numbering() {
        if (this.refer1Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`REFER1_ID`) IS NULL THEN 0 ELSE MAX(e.`REFER1_ID`) * 1 END + 1 AS `REFER1_ID` FROM TB1_REFER1 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("REFER1_ID");
        this.setRefer1Id(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`REFER1_MEI` = :refer_1_mei");
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("refer_1_mei", this.refer1Mei);
