 ...
 * @author emarfkrow
 */
public class Tb1Refer3 implements IEntity {
    ...
    /** @return 参照３ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REFER3_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @return 参照３名 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "REFER3_MEI", index = 3)
     ...
     * @return 参照３マスタ
     */
    public static Tb1Refer3 get(final Object param1) {
        ...
        map.put("refer_3_id", param1);
        return Queries.get(sql, map, Tb1Refer3.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照３マスタの登録
        String sql = "INSERT INTO TB1_REFER3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`REFER3_MEI` -- :refer_3_mei");
    ...
    private void numbering() {
        if (this.refer3Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`REFER3_ID`) IS NULL THEN 0 ELSE MAX(e.`REFER3_ID`) * 1 END + 1 AS `REFER3_ID` FROM TB1_REFER3 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("REFER3_ID");
        this.setRefer3Id(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`REFER3_MEI` = :refer_3_mei");
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("refer_3_mei", this.refer3Mei);
