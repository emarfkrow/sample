 ...
 * @author emarfkrow
 */
public class Tb3BeginHis implements IEntity {
    ...
    /** @return 当初情報 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "BEGIN_INFO", index = 4)
     ...
     * @return 履歴
     */
    public static Tb3BeginHis get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb3BeginHis.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 履歴の登録
        String sql = "INSERT INTO TB3_BEGIN_HIS(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`RIREKI_BN`) IS NULL THEN 0 ELSE MAX(e.`RIREKI_BN`) * 1 END + 1 AS `RIREKI_BN` FROM TB3_BEGIN_HIS e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
        whereList.add("e.`BEGIN_ID` = :begin_id");
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 履歴の登録
        String sql = "UPDATE TB3_BEGIN_HIS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 履歴の削除
        String sql = "DELETE FROM TB3_BEGIN_HIS WHERE " + getWhere();
