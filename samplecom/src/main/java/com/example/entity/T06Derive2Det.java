...
public class T06Derive2Det implements IEntity {
    ...
    /** デフォルトコンストラクタ */
    public T06Derive2Det() {
    }

    /** @param values */
    public T06Derive2Det(final String[] values) {
    ...
    /** @param map */
    public T06Derive2Det(final java.util.Map<String, Object> map) {
    ...
    public static T06Derive2Det get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T06Derive2Det.class);
    }
