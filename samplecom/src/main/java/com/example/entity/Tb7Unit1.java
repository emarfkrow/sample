 ...
 * @author emarfkrow
 */
public class Tb7Unit1 implements IEntity {
    ...
    /** @return 単位１ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "UNIT1_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @param o 単位１ID */
    @jp.co.golorp.emarf.validation.PrimaryKeys
    public void setUnit1Id(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(o)) {
            this.unit1Id = Integer.valueOf(o.toString());
        } else {
            this.unit1Id = null;
        }
    }
     ...
     * @return 単位１
     */
    public static Tb7Unit1 get(final Object param1) {
        List<String> whereList = new ArrayList<String>();
        whereList.add("`UNIT1_ID` = :unit_1_id");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.`UNIT1_ID` \n";
        sql += "    , a.`SUM_ID` \n";
        ...
        map.put("unit_1_id", param1);
        return Queries.get(sql, map, Tb7Unit1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 単位１の登録
        String sql = "INSERT INTO TB7_UNIT1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`UNIT1_ID` -- :unit_1_id");
    ...
    private void numbering() {
        if (this.unit1Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`UNIT1_ID`) IS NULL THEN 0 ELSE MAX(e.`UNIT1_ID`) * 1 END + 1 AS `UNIT1_ID` FROM TB7_UNIT1 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("UNIT1_ID");
        this.setUnit1Id(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`UNIT1_ID` = :unit_1_id");
    ...
    public int delete() {
        ...
        // 単位１の削除
        String sql = "DELETE FROM TB7_UNIT1 WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("unit_1_id", this.unit1Id);
