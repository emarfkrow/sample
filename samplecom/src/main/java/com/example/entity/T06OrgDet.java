...
public class T06OrgDet implements IEntity {
    ...
    /** @param values */
    public T06OrgDet(final String[] values) {
    ...
    /** @param map */
    public T06OrgDet(final java.util.Map<String, Object> map) {
    ...
    public static T06OrgDet get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T06OrgDet.class);
    }
