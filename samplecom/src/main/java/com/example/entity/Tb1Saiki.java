 ...
 * @author emarfkrow
 */
public class Tb1Saiki implements IEntity {
     ...
     * @return 再帰
     */
    public static Tb1Saiki get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb1Saiki.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 再帰の登録
        String sql = "INSERT INTO TB1_SAIKI(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SAIKI_ID`) IS NULL THEN 0 ELSE MAX(e.`SAIKI_ID`) * 1 END + 1 AS `SAIKI_ID` FROM TB1_SAIKI e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 再帰の削除
        String sql = "DELETE FROM TB1_SAIKI WHERE " + getWhere();
