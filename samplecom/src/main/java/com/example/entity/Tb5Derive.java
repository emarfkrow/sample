 ...
 * @author emarfkrow
 */
public class Tb5Derive implements IEntity {
    ...
    /** @return 派生ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "DERIVE_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @param o 派生ID */
    @jp.co.golorp.emarf.validation.PrimaryKeys
    public void setDeriveId(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(o)) {
            this.deriveId = Integer.valueOf(o.toString());
        } else {
            this.deriveId = null;
        }
    }
     ...
     * @return 派生
     */
    public static Tb5Derive get(final Object param1) {
        List<String> whereList = new ArrayList<String>();
        whereList.add("`DERIVE_ID` = :derive_id");
        String sql = "";
        sql += "SELECT \n";
        sql += "      a.`DERIVE_ID` \n";
        sql += "    , a.`PREV_ID` \n";
        ...
        map.put("derive_id", param1);
        return Queries.get(sql, map, Tb5Derive.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 派生の登録
        String sql = "INSERT INTO TB5_DERIVE(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`DERIVE_ID` -- :derive_id");
    ...
    private void numbering() {
        if (this.deriveId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`DERIVE_ID`) IS NULL THEN 0 ELSE MAX(e.`DERIVE_ID`) * 1 END + 1 AS `DERIVE_ID` FROM TB5_DERIVE e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("DERIVE_ID");
        this.setDeriveId(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`DERIVE_ID` = :derive_id");
    ...
    public int delete() {
        ...
        // 派生の削除
        String sql = "DELETE FROM TB5_DERIVE WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("derive_id", this.deriveId);
