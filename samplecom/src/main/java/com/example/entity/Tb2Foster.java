 ...
 * @author emarfkrow
 */
public class Tb2Foster implements IEntity {
     ...
     * @return 里子
     */
    public static Tb2Foster get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb2Foster.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 里子の登録
        String sql = "INSERT INTO TB2_FOSTER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`BRO_ID`) IS NULL THEN 0 ELSE MAX(e.`BRO_ID`) * 1 END + 1 AS `BRO_ID` FROM TB2_FOSTER e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 里子の削除
        String sql = "DELETE FROM TB2_FOSTER WHERE " + getWhere();
