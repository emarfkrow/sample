...
public class T09Grp2 implements IEntity {
    ...
    /** @param values */
    public T09Grp2(final String[] values) {
    ...
    /** @param map */
    public T09Grp2(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.grp2Id)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static T09Grp2 get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T09Grp2.class);
    }
