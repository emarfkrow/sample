...
public class T14Jisseki implements IEntity {
    ...
    private String values() {
        ...
        valueList.add("TO_DATE (SUBSTR (:jisshi_bi, 0, 10), 'YYYY-MM-DD')");
        valueList.add("TO_DATE (SUBSTR (:kanryo_bi, 0, 10), 'YYYY-MM-DD')");
    ...
    private String getSet() {
        ...
        setList.add("\"JISSHI_BI\" = TO_DATE (SUBSTR (:jisshi_bi, 0, 10), 'YYYY-MM-DD')");
        setList.add("\"KANRYO_BI\" = TO_DATE (SUBSTR (:kanryo_bi, 0, 10), 'YYYY-MM-DD')");
