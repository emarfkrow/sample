...
public class T02Eldest implements IEntity {
    ...
    /** @param values */
    public T02Eldest(final String[] values) {
    ...
    /** @param map */
    public T02Eldest(final java.util.Map<String, Object> map) {
    ...
    public static T02Eldest get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T02Eldest.class);
    }
    ...
    public static int truncate() {
        ...
        // 長兄の削除
        String sql = "TRUNCATE TABLE T02_ELDEST";
