...
public class T07PrevDet implements IEntity {
    ...
    /** @param values */
    public T07PrevDet(final String[] values) {
    ...
    /** @param map */
    public T07PrevDet(final java.util.Map<String, Object> map) {
    ...
    public static T07PrevDet get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T07PrevDet.class);
    }
    ...
    public static int truncate() {
        ...
        // 前世明細の削除
        String sql = "TRUNCATE TABLE T07_PREV_DET";
