...
public class M05Ref2 implements IEntity {
    ...
    /** @param values */
    public M05Ref2(final String[] values) {
    ...
    /** @param map */
    public M05Ref2(final java.util.Map<String, Object> map) {
    ...
    public static M05Ref2 get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, M05Ref2.class);
    }
    ...
    public static int truncate() {
        ...
        // マスタ参照２の削除
        String sql = "TRUNCATE TABLE M05_REF2";
