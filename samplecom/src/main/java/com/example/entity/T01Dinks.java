...
public class T01Dinks implements IEntity {
    ...
    /** @param values */
    public T01Dinks(final String[] values) {
    ...
    /** @param map */
    public T01Dinks(final java.util.Map<String, Object> map) {
    ...
    public static T01Dinks get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T01Dinks.class);
    }
    ...
    public static int truncate() {
        ...
        // 子なしの削除
        String sql = "TRUNCATE TABLE T01_DINKS";
