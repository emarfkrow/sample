...
public class T07RebornDet implements IEntity {
    ...
    /** @param values */
    public T07RebornDet(final String[] values) {
    ...
    /** @param map */
    public T07RebornDet(final java.util.Map<String, Object> map) {
    ...
    public static T07RebornDet get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T07RebornDet.class);
    }
    ...
    public static int truncate() {
        ...
        // 転生明細の削除
        String sql = "TRUNCATE TABLE T07_REBORN_DET";
