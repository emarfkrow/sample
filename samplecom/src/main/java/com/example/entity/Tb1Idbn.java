 ...
 * @author emarfkrow
 */
public class Tb1Idbn implements IEntity {
     ...
     * @return ID連番マスタ
     */
    public static Tb1Idbn get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb1Idbn.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // ID連番マスタの登録
        String sql = "INSERT INTO TB1_IDBN(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`IDBN_BN`) IS NULL THEN 0 ELSE MAX(e.`IDBN_BN`) * 1 END + 1 AS `IDBN_BN` FROM TB1_IDBN e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // ID連番マスタの削除
        String sql = "DELETE FROM TB1_IDBN WHERE " + getWhere();
