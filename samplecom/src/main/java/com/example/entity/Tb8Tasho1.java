 ...
 * @author emarfkrow
 */
public class Tb8Tasho1 implements IEntity {
     ...
     * @return 他生１
     */
    public static Tb8Tasho1 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb8Tasho1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 他生１の登録
        String sql = "INSERT INTO TB8_TASHO1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`TASHO1_ID`) IS NULL THEN 0 ELSE MAX(e.`TASHO1_ID`) * 1 END + 1 AS `TASHO1_ID` FROM TB8_TASHO1 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 他生１の削除
        String sql = "DELETE FROM TB8_TASHO1 WHERE " + getWhere();
