...
public class T10Koho1 implements IEntity {
    ...
    /** @param values */
    public T10Koho1(final String[] values) {
    ...
    /** @param map */
    public T10Koho1(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.koho1Id)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static T10Koho1 get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T10Koho1.class);
    }
    ...
    public static int truncate() {
        ...
        // 候補１の削除
        String sql = "TRUNCATE TABLE T10_KOHO1";
