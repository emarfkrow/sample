...
public class T04Comp1 implements IEntity {
    ...
    public static java.util.List<T04Comp2> referT04Comp2s(final Integer param1, final Integer param2) {
        ...
        String sql = "SELECT ";
        sql += "\"ref1_id\"";
        sql += ", (SELECT r0.\"ref1_mei\" FROM M04_REF1 r0 WHERE r0.\"ref1_id\" = a.\"ref1_idref1_id\") AS \"ref1_mei\"";
        sql += ", \"ref2_id\"";
        sql += ", (SELECT r1.\"ref2_mei\" FROM M04_REF2 r1 WHERE r1.\"ref2_id\" = a.\"ref2_idref2_id\") AS \"ref2_mei\"";
        sql += ", \"ref3_id\"";
        sql += ", (SELECT r2.\"ref3_mei\" FROM M04_REF3 r2 WHERE r2.\"ref3_id\" = a.\"ref3_idref3_id\") AS \"ref3_mei\"";
        sql += ", TO_CHAR (\"tekiyo_bi\", 'YYYY-MM-DD') AS tekiyo_bi";
        sql += ", \"comp2_info\"";
        sql += ", TO_CHAR (\"insert_ts\", 'YYYY-MM-DD HH24:MI:SS.MS') AS insert_ts";
        sql += ", \"insert_user_id\"";
        sql += ", (SELECT r3.\"user_sei\" FROM MHR_USER r3 WHERE r3.\"user_id\" = a.\"insert_user_iduser_id\") AS \"insert_user_sei\"";
        sql += ", TO_CHAR (\"update_ts\", 'YYYY-MM-DD HH24:MI:SS.MS') AS update_ts";
        sql += ", \"update_user_id\"";
        sql += ", (SELECT r4.\"user_sei\" FROM MHR_USER r4 WHERE r4.\"user_id\" = a.\"update_user_iduser_id\") AS \"update_user_sei\"";
