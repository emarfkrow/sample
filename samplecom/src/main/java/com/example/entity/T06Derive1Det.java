...
public class T06Derive1Det implements IEntity {
    ...
    /** デフォルトコンストラクタ */
    public T06Derive1Det() {
    }

    /** @param values */
    public T06Derive1Det(final String[] values) {
    ...
    /** @param map */
    public T06Derive1Det(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.derive1Bn)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static T06Derive1Det get(final Object param1, final Object param2) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T06Derive1Det.class);
    }
    ...
    public static int truncate() {
        ...
        // 派生１明細の削除
        String sql = "TRUNCATE TABLE T06_DERIVE1_DET";
