...
public class T02Foster implements IEntity {
    ...
    /** @param values */
    public T02Foster(final String[] values) {
    ...
    /** @param map */
    public T02Foster(final java.util.Map<String, Object> map) {
    ...
    public static T02Foster get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T02Foster.class);
    }
