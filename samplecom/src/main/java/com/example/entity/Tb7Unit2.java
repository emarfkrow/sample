 ...
 * @author emarfkrow
 */
public class Tb7Unit2 implements IEntity {
    ...
    /** @return 単位２ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "UNIT2_ID", index = 2)
    @jp.co.golorp.emarf.validation.PrimaryKeys
    ...
    /** @param o 単位２ID */
    @jp.co.golorp.emarf.validation.PrimaryKeys
    public void setUnit2Id(final Object o) {
        if (!jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(o)) {
            this.unit2Id = Integer.valueOf(o.toString());
        } else {
            this.unit2Id = null;
        }
    }
     ...
     * @return 単位２
     */
    public static Tb7Unit2 get(final Object param1) {
        ...
        map.put("unit_2_id", param1);
        return Queries.get(sql, map, Tb7Unit2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 単位２の登録
        String sql = "INSERT INTO TB7_UNIT2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`UNIT2_ID`) IS NULL THEN 0 ELSE MAX(e.`UNIT2_ID`) * 1 END + 1 AS `UNIT2_ID` FROM TB7_UNIT2 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("UNIT2_ID");
        this.setUnit2Id(o);
    }
    ...
    public int delete() {
        ...
        // 単位２の削除
        String sql = "DELETE FROM TB7_UNIT2 WHERE " + getWhere();
