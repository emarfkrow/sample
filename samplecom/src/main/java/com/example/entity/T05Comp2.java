...
public class T05Comp2 implements IEntity {
    ...
    /** @param values */
    public T05Comp2(final String[] values) {
    ...
    /** @param map */
    public T05Comp2(final java.util.Map<String, Object> map) {
    ...
    public static T05Comp2 get(final Object param1, final Object param2, final Object param3, final Object param4) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T05Comp2.class);
    }
    ...
    public static int truncate() {
        ...
        // 複合２の削除
        String sql = "TRUNCATE TABLE T05_COMP2";
