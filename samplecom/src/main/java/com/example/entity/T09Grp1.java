...
public class T09Grp1 implements IEntity {
    ...
    /** @param values */
    public T09Grp1(final String[] values) {
    ...
    /** @param map */
    public T09Grp1(final java.util.Map<String, Object> map) {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.grp1Id)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static int truncate() {
        ...
        // 集団１の削除
        String sql = "TRUNCATE TABLE T09_GRP1";
