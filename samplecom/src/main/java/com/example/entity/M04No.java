...
public class M04No implements IEntity {
    ...
    public boolean isNew() {
        ...
        // 主キーが不足していたらINSERT
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(this.norefNo)) {
            isNew = true;
        }
        // 楽観ロック値がなくてもINSERT
    ...
    public static M04No get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, M04No.class);
    }
    ...
    public static int truncate() {
        ...
        // NOマスタの削除
        String sql = "TRUNCATE TABLE M04_NO";
