 ...
 * @author emarfkrow
 */
public class Tb1Idref implements IEntity {
     ...
     * @return ID参照マスタ
     */
    public static Tb1Idref get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb1Idref.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // ID参照マスタの登録
        String sql = "INSERT INTO TB1_IDREF(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`IDREF_ID`) IS NULL THEN 0 ELSE MAX(e.`IDREF_ID`) * 1 END + 1 AS `IDREF_ID` FROM TB1_IDREF e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // ID参照マスタの削除
        String sql = "DELETE FROM TB1_IDREF WHERE " + getWhere();
