 ...
 * @author emarfkrow
 */
public class Tb4Mago implements IEntity {
     ...
     * @return 孫
     */
    public static Tb4Mago get(final Object param1, final Object param2, final Object param3) {
        ...
        return Queries.get(sql, map, Tb4Mago.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 孫の登録
        String sql = "INSERT INTO TB4_MAGO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`MAGO_BN`) IS NULL THEN 0 ELSE MAX(e.`MAGO_BN`) * 1 END + 1 AS `MAGO_BN` FROM TB4_MAGO e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // 孫の削除
        String sql = "DELETE FROM TB4_MAGO WHERE " + getWhere();
