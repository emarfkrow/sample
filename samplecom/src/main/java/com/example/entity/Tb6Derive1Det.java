 ...
 * @author emarfkrow
 */
public class Tb6Derive1Det implements IEntity {
     ...
     * @return 派生１明細
     */
    public static Tb6Derive1Det get(final Object param1, final Object param2) {
        ...
        sql += "FROM \n";
        sql += "    TB6_DERIVE1_DET a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("derive_1_id", param1);
        map.put("derive_1_bn", param2);
        return Queries.get(sql, map, Tb6Derive1Det.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 派生１明細の登録
        String sql = "INSERT INTO TB6_DERIVE1_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`DERIVE1_BN`) IS NULL THEN 0 ELSE MAX(e.`DERIVE1_BN`) * 1 END + 1 AS `DERIVE1_BN` FROM TB6_DERIVE1_DET e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 派生１明細の登録
        String sql = "UPDATE TB6_DERIVE1_DET\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 派生１明細の削除
        String sql = "DELETE FROM TB6_DERIVE1_DET WHERE " + getWhere();
