 ...
 * @author emarfkrow
 */
public class Tb4KoDinks implements IEntity {
     ...
     * @return 子なし
     */
    public static Tb4KoDinks get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb4KoDinks.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 子なしの登録
        String sql = "INSERT INTO TB4_KO_DINKS(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KO_BN`) IS NULL THEN 0 ELSE MAX(e.`KO_BN`) * 1 END + 1 AS `KO_BN` FROM TB4_KO_DINKS e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 子なしの登録
        String sql = "UPDATE TB4_KO_DINKS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
