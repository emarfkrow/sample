...
public class T02Younger implements IEntity {
    ...
    /** @param values */
    public T02Younger(final String[] values) {
    ...
    /** @param map */
    public T02Younger(final java.util.Map<String, Object> map) {
    ...
    public static T02Younger get(final Object param1) {
        ...
        return jp.co.golorp.emarf.sql.Queries.get(sql, map, T02Younger.class);
    }
