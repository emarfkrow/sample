 ...
 * @author emarfkrow
 */
public class Tb9Dest implements IEntity {
     ...
     * @return 変換先
     */
    public static Tb9Dest get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb9Dest.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変換先の登録
        String sql = "INSERT INTO TB9_DEST(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`DEST_ID`) IS NULL THEN 0 ELSE MAX(e.`DEST_ID`) * 1 END + 1 AS `DEST_ID` FROM TB9_DEST e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 変換先の削除
        String sql = "DELETE FROM TB9_DEST WHERE " + getWhere();
