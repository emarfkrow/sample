 ...
 * @author emarfkrow
 */
public class Tb9Furiwake implements IEntity {
    ...
    public static Tb9Furiwake get() {
        ...
        return Queries.get(sql, map, Tb9Furiwake.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // VIEWの登録
        String sql = "INSERT INTO TB9_FURIWAKE(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // VIEWの登録
        String sql = "UPDATE TB9_FURIWAKE\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // VIEWの削除
        String sql = "DELETE FROM TB9_FURIWAKE WHERE " + getWhere();
