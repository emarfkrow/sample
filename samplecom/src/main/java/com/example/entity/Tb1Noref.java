 ...
 * @author emarfkrow
 */
public class Tb1Noref implements IEntity {
     ...
     * @return NO参照マスタ
     */
    public static Tb1Noref get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb1Noref.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // NO参照マスタの登録
        String sql = "INSERT INTO TB1_NOREF(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // NO参照マスタの削除
        String sql = "DELETE FROM TB1_NOREF WHERE " + getWhere();
