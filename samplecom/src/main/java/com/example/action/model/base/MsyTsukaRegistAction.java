 ...
 * @author emarfkrow
 */
public class MsyTsukaRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        // 主キーが不足していたらINSERT
        boolean isNew = false;
        if (jp.co.golorp.emarf.lang.StringUtil.isNullOrWhiteSpace(e.getTsukaKb())) {
            isNew = true;
        }
        ...
        if (isNew) {
            ...
            if (e.insert(now, execId) != 1) {
                throw new OptLockError("error.cant.insert", "通貨マスタ");
            }
            ...
            if (e.update(now, execId) == 1) {
                ...
                throw new OptLockError("error.cant.update", "通貨マスタ");
            }
        }
