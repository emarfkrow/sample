 ...
 * @author emarfkrow
 */
public class Tb1Refer1SRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb1Refer1Grid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Tb1Refer1 e = FormValidator.toBean(Tb1Refer1.class.getName(), row);
