 ...
 * @author emarfkrow
 */
public class Tb1IdbnSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb1IdbnGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Tb1Idbn e = FormValidator.toBean(Tb1Idbn.class.getName(), row);
                if (e.delete() != 1) {
                    throw new OptLockError("error.cant.delete", "ID連番マスタ");
                }
                ++count;
