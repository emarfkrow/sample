 ...
 * @author emarfkrow
 */
public class Tb4OyaSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb4OyaGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Tb4Oya e = FormValidator.toBean(Tb4Oya.class.getName(), row);
